...
export const DATA = {
    ...
    projects: [
        ...
        {
            title: "Clipscript",
            href: "https://github.com/surajkuushwaha/clipscript",
            dates: "Apr 2026 - Present",
            active: true,
            description:
                "HTTP API that converts Instagram Reels and YouTube Shorts URLs into text transcripts. A Go Fiber service validates links, extracts audio with yt-dlp, streams it to Whisper (go-whisper in Docker or OpenAI), and returns transcripts with optional proxy pooling for downloads.",
            technologies: ["Go", "Fiber", "Docker", "yt-dlp", "Whisper"],
            links: [
                {
                    type: "Source",
                    href: "https://github.com/surajkuushwaha/clipscript",
