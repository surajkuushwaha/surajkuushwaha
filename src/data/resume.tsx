    ...
    work: [
        {
            ...
            description: `Architected and scaled AWS-based backend microservices (EC2, SQS, Lambda) handling 5M+ monthly requests for 100+ global brands. Led strategic migration from siloed multi-database architecture to unified SaaS model with zero-downtime migration for 30+ legacy clients. Built and launched 10+ MVPs using Node.js, TypeScript, and MySQL, securing the company's first client and establishing the core influencer marketing platform. Transformed an internal tool into a public-facing API product, managing its full lifecycle from design to deployment and maintenance.`,
        },
    ] as Array<{
        company: string;
        href: string;
